# ✅ Thêm hướng dẫn deploy + requirements.txt

# Đây vẫn là file app.py
# Tạo thêm file requirements.txt như sau:
...
# Khi push lên GitHub, repo cần có:
# - app.py (file này)
# - requirements.txt (chứa các dòng trên)

# Nếu deploy Render, thêm file Procfile:
# ------------------------------
# web: streamlit run app.py --server.port=$PORT

# Sau đó:
# 1️⃣ Đẩy repo lên GitHub.
# 2️⃣ Đăng ký tài khoản tại render.com hoặc Streamlit Community Cloud.
# 3️⃣ Kết nối repo, chọn app.py làm file chạy.
# 4️⃣ Chạy build và chạy web 24/7 miễn phí!

# ⚡ Lưu ý: Streamlit Cloud sẽ sleep nhẹ khi không có truy cập, nhưng tự wake khi có request mới.
